...
INSERT INTO sys_menu (
  ...
  (12, 0, '商品管理', 'C', '/products', 'ProductManageView', 'product:view', 'Goods', 20, 1, 1, NULL, NOW(), NOW(), 0),
  (13, 12, '新增商品', 'F', NULL, NULL, 'product:create', NULL, 10, 0, 1, NULL, NOW(), NOW(), 0),
  (14, 12, '修改商品', 'F', NULL, NULL, 'product:update', NULL, 20, 0, 1, NULL, NOW(), NOW(), 0),
  (15, 12, '删除商品', 'F', NULL, NULL, 'product:delete', NULL, 30, 0, 1, NULL, NOW(), NOW(), 0),
  (16, 12, '商品类型维护', 'F', NULL, NULL, 'product:type:manage', NULL, 40, 0, 1, NULL, NOW(), NOW(), 0),
